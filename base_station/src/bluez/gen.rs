...
pub trait Battery1 {
    type Err;
    fn get_percentage(&self) -> Result<u8, Self::Err>;
}

impl<'a, C: ::std::ops::Deref<Target=dbus::Connection>> Battery1 for dbus::ConnPath<'a, C> {
    type Err = dbus::Error;

    fn get_percentage(&self) -> Result<u8, Self::Err> {
        <Self as dbus::stdintf::org_freedesktop_dbus::Properties>::get(&self, "org.bluez.Battery1", "Percentage")
    }
}

pub fn battery1_server<F, T, D>(factory: &tree::Factory<tree::MTFn<D>, D>, data: D::Interface, f: F) -> tree::Interface<tree::MTFn<D>, D>
where
    D: tree::DataType,
    D::Method: Default,
    D::Property: Default,
    T: Battery1<Err=tree::MethodErr>,
    F: 'static + for <'z> Fn(& 'z tree::MethodInfo<tree::MTFn<D>, D>) -> & 'z T,
{
