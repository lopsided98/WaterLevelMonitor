...
static int nrfx_adc_supply_init(const struct device* dev) {
    ...
    struct adc_channel_cfg adc_cfg = {.channel_id = 0,  // FIXME: should this be configurable?
...
DEVICE_DT_INST_DEFINE(0, &nrfx_adc_supply_init, NULL, &nrfx_adc_supply_data, NULL, POST_KERNEL,
                      CONFIG_SENSOR_INIT_PRIORITY, &nrfx_adc_supply_api);
